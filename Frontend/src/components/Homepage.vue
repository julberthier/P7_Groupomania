        ...
        <p class="form_info" v-else>Tu as déjà un compte ? <span v-on:click="loggedIn()" class="account">Se connecter</span></p>
          ...
          <div class="form_container_size"> 
            <form action="" class="form_style">              
              ...
              <span class="passwordHide" v-if="signed == false">
              </span>
              <button type="button" class="form_btn minima">
                <span v-if="signed == true">Connexion</span> 
                <span v-else @click="signUp()">S'inscrire</span>
              </button>
            </form>
          </div>
    </div>   
